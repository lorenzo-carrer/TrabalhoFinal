            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                        height="500" xmlns="http://www.w3.org/2000/svg" xmlns="../xlink" role="img" aria-label="Placeholder: 500x500"
                        preserveAspectRatio="xMidYMid slice" focusable="false">
                        <rect width="100%" height="100%" fill="#eee"/>
                        <image xlink:href="img/quemSomos.jpg"  style="height:100%" alt="quemSomos">
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 order-md-1">
                    <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                        ...
                        preserveAspectRatio="xMidYMid slice" focusable="false">
                        <rect width="100%" height="100%" fill="#eee"/>
                        <image xlink:href="img/comprar.jpg"  style="height:100%" alt="comprar">
                        <text x="50%" y="50%" fill="#aaa" dy=".3em"></text>
                    </svg>
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                        ...
                        preserveAspectRatio="xMidYMid slice" focusable="false">
                        <rect width="100%" height="100%" fill="#eee"/>
                        <image xlink:href="img/dinheiro.jpg"  style="height:100%" alt="dinheiro">
                        <text x="50%" y="50%" fill="#aaa" dy=".3em"></text>
                    </svg>
